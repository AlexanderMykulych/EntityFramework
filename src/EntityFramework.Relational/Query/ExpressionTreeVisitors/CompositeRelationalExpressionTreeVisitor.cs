...
namespace Microsoft.Data.Entity.Relational.Query.ExpressionTreeVisitors
{
    public class CompositePredicateExpressionTreeVisitor : ExpressionTreeVisitor
    {
            ...
            [NotNull]Expression expression)
        {
            ...
            var useDatabaseNullSemantics = _queryAnnotations.OfType<UseDatabaseNullSemanticsQueryAnnotation>().Any();
            if (!parameterDectector.ContainsParameters && !useDatabaseNullSemantics)
            {
